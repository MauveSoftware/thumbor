################################### Authors ####################################
# originated from https://github.com/MinimalCompact/thumbor 
# modified by Mauve Mailorder Software GmbH & Co. KG
...
LOADER = '{{ LOADER | default('thumbor.loaders.http_loader_cache_control') }}'

## The file storage thumbor should use to store original images. This must be the
## full name of a python module (python must be able to import it)
## Defaults to: thumbor.storages.file_storage
STORAGE = '{{ STORAGE | default('thumbor.storages.file_storage_cache_control') }}'
...
RESULT_STORAGE = '{{ RESULT_STORAGE | default('thumbor.result_storages.file_storage_cache_control') }}'
...
## month
## Defaults to: 2592000
STORAGE_EXPIRATION_SECONDS = {{ STORAGE_EXPIRATION_SECONDS | default(0) }}
